...
int main() {
    ...
    r0p (i, n) r0p (j, n) { int x; cin >> x; nf.adde(i, j + n, 1, x); }
    r0p (i, n) nf.adde(s, i, 1, 0), nf.adde(i + n, t, 1, 0);
    cout << nf.max_flow(s, t, n).c << '\n';
    each (e, nf.edges()) e.c *= -1;
    cout << -nf.max_flow(s, t, n).c << '\n';
