...
int main() {
    ...
    each (x, a) {
        cin >> x.a >> x.b >> x.c >> x.d, x.l = x.len();
        if (x.a > x.c) swap(x.a, x.c);
        x.a *= 2, x.c *= 2, (x.a == x.c ? x.a : x.c) -= 1;
        b.push_back(x.a), b.push_back(x.c);
    }
    ...
    each (x, a) nf.adde(id(x.a), id(x.c), 1, -x.l);
